...
public class Logging implements java.io.Serializable {
	...
	/** full constructor */
	public Logging(Users users, Date opTime, String sysDesc,
			String detailsInfo) {
		this.userId = userId;
		this.opTime = opTime;
	...
	@Column(name = "sys_desc_id", length = 20)
	public String getSysDescId() {
		return sysDescId;
	}

	public void setSysDescId(String sysDescId) {
		this.sysDescId = sysDescId;
	}
