...
<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" href="js/DataTables-1.10.13/media/css/jquery.dataTables.min.css" />
		 <script type="text/javascript">
				...
				function chaiquan(){
					button=[];
					$("[name='checkButton']").each(function (){
						button.push($(this).attr("id"));
						change($(this));
	...
	<body>
	<!-- 条件输入框 -->	
  <form class="form-inline" role="form" action="toListFilesYi.do">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div class="btn-group btn-group-lg">
    <button type="button" class="btn btn-default tooltip-test" data-toggle="tooltip" onclick="" title="加入当前卷" onclick="jiaru()"><span class="glyphicon glyphicon-plus-sign"></span></button>
    <button type="button" class="btn btn-default tooltip-test" data-toggle="tooltip" onclick="chequan()" title="撤出当前卷"><span class="glyphicon glyphicon-pencil"></span></button>
	<button type="button" class="btn btn-default tooltip-test" data-toggle="tooltip" onclick="chaiquan()" title="拆卷"><span class="glyphicon glyphicon-pencil"></span></button>
</div>

<!-- 编辑窗口 -->
<c:forEach var="file" items="${Yfiles}">
          ...
          <div class="x_content">
			...
			<ul class="list-group">
				...
				<div class="message_date">
					...
					<button type="button" name="checkButton" class="btn btn-primary" id="${file.id}" onclick="change(this)">点击选中</button>
				</div>
				</li>
				<li class="list-group-item">
