...
<head>
    ...
    <title>重要密品安全管理系统 |  <sitemesh:write property='title' />  </title>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                             ...
                             <ul class="nav side-menu">
                                ...
                                <!-- <li><a href="http://192.168.18.1:8088/sfcms/main.jsp"><i class="fa fa-laptop"></i>文件审计 </a>
                                </li> -->
                            </ul>
                        </div>
                ...
                <footer>
                    <div class="">
                        <p class="pull-right"> Copyright © 2015 鹏越惊虹. All Rights Reserved
                            | <span class="lead"> 重要密品安全管理系统</span>
                        </p>
                    </div>
                    <div class="clearfix"></div>
                </footer>
