...
<html>
	<head>
		...
		$(function(){
			CommonCud.init({
				 "addUrl": "ajaxAddUsers.do?passWord="+hex_md5('123456')
                     ...
                     <div class="modal-body">
                     	<form class="form-horizontal form-label-left">
                             <div class="form-group">
                                 <label>登录名</label>
                                 <input type="text" name="userName" class="form-control" placeholder="登录名" onblur="checkUser()">
                             </div>
                             <div class="form-group">
                                 <label>姓名</label>
