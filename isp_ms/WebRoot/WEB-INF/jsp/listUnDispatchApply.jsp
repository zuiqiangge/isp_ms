					...
					<div class="modal-body">
						<form class="form-horizontal form-label-left">
							...
							<div class="form-group">
							 ...
							 &nbsp;&nbsp;	
                             <input type="radio" name="test" value="0"  >外来车浪
                              &nbsp;&nbsp;
                                <input type="radio" name="test" value="1" checked>现有车辆
                               
                                
								
								--><!--
								 
								  <input type="text" id="car1" name="car_id" class="form-control"/>
								   
								--><select id="car2" name="car_id" class="form-control">
